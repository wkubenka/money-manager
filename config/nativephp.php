...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.astutemoney.app'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Personal finance app based on I Will Teach You To Be Rich'),

    /**
     * The Website of your application.
     */
    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://astutemoney.com'),
    ...
    'updater' => [
        ...
        'providers' => [
            'github' => [
                'driver' => 'github',
                'repo' => env('GITHUB_REPO', 'money-manager'),
                'owner' => env('GITHUB_OWNER', 'wkubenka'),
